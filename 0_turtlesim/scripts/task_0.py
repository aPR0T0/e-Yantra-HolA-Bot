...
current_x, current_y, counter, init_x, init_y, counter_2, counter_3 = 0,0,0,0,0,0,0
...
def CalcPose(msg):
    ...
    global current_x, current_y, counter, init_x, init_y
...
def callback(msg):
    ...
    if (counter != 0):
        ...
        if (2 <= current_y-init_y <= 2.03 and 0.021 >= current_x-init_x >= -0.021):
            ...
            speed.linear.x = (math.pi)
            speed.angular.z = math.pi

        elif (counter_2 != 0):
            if (0.05 >= current_y - init_y >= -0.05 and 0.05 >= current_x - init_x >= -0.05):
                speed.linear.y = 0
                speed.linear.x = 0
                speed.angular.z = 0
