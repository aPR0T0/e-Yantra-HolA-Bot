...
static const char *TAG = "current_pose";
static char scratch[SCRATCH_BUFSIZE];
static pid_const_t pid_constants = {.kp = 250, .ki = 250, .kd = -2.785, .val_changed = true};
...
static esp_err_t start_current_pose_private()
{
...
void start_current_pose()
{
    ...
    ESP_ERROR_CHECK(start_current_pose_private());
